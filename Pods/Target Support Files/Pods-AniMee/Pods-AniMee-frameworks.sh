...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods-AniMee/MBLogger.framework"
  install_framework "Pods-AniMee/MobiletteFoundation.framework"
  install_framework "Pods-AniMee/NSLogger.framework"
